...
//	}
	...
	{
		XElement designs = XMLUtils.FindElementByName(project, "FurnitureDesigns");
	...
	{
		int resolution = int.Parse(XMLUtils.FindValueByName (furniture, "Resolution"));
		if (int.Parse (XMLUtils.FindValueByName (furniture, "TerrainUseCount")) > 0) {
